...
> - 这部分主要集中了我在做学习开发中随手参考所要用到的几乎所有在线教程和官方文档，有中文版文档的我基本都优先列出来了，但更多时候是英文的官方文档。
...
经常听到有人提出有关编程环境搭建和基础软件设施安装的相关问题。
...
---
> [!WARNING]
>  数据结构和算法题对于程序员的重要性不言而喻。参加过笔试或者面试过的人都应该知道，可以说这个东西某一程度上直接决定了面试的成败，现在的互联网公司技术岗面试，数据结构+算法题基本都是必选项。除了几种基础数据结构类型得烂熟于心，基本的几大算法(或者说算法思想)也要了如指掌之外，参加求职前，不论是校招还是社招，非常有必要好好刷一刷LeetCode上的数据结构和算法题，以保持题感。
---
...
---
> [!WARNING]
>  数据库不言而喻，所谓说谁拥有了数据谁就拥有了所有，可见数据库的重要性，数据库又是大数据的基础，基于服务端所有后端软件都需要数据库，曾经看到过这样一句话，你只要精通数据库，走到哪里都有人要，所以数据库更是极为重要的

---
> 给大家介绍一下我自学数据库时的资源视频
- [数据库mysql基础+高级篇](https://www.bilibili.com/video/BV12b411K7Zu)
- 内容持续更新中...
...
---
> [!NOTE]
>  该板块会持续更新各技术方向的求职面试题集合、面经、以及一些我搜索到的求职心得与经历感悟。
...
- 03年在校大学生一枚，专科学校，自2017年开始接触编程，从此便一发不可收拾
