...
> **编码课程**
>
> - [**慕课网**](https://www.imooc.com/)*国内学习编程的网站，有些内容付费*
...
> - [**洛谷官网**](https://www.luogu.com.cn/)*适合时间充裕的人*
...
> **通用**
>
> - [**考试酷**](https://www.examcoo.com/index/ku)*永久免费的公共题库中心*
...
> - [**菜鸟工具**](https://c.runoob.com/compile/10)*一款Java在线、无需配置环境，随时随地写代码的工具*
...
> - [**AII To AII**](https://www.alltoall.net/)*国内最全类型的在线文件转换平台，非常全能免费快速*
> - [**Office Converter**](https://cn.office-converter.com/)*免费在线转换包括图片，视频，文档和压缩功能*
...
> ## **其他**
>
> - [**盒子部落**](https://www.imooc.com/)*国内热门的电脑手机软件评测与下载网站*
...
> - [**`HelloGitHub` 开源项目**](https://hellogithub.com/)*开源项目练习*
> - [**开源中国软件频道**](https://www.oschina.net/project/tags)*一款开源的中国项目*
> - [**Gitee**](https://gitee.com/)*国内版的GitHub*
...
> - [**`CodeVsColor`**](https://www.codevscolor.com/)*编程语言的免费在线教程*
> - [**`W3school`**](https://www.w3school.com.cn/)*编程语言的在线免费教程*
> - [**简单教程**](https://www.twle.cn/)*完全免费，高质量编程开发学习网站，一系列教程*
> - [**`FreeAIHub`**](https://www.freeaihub.com/)*免费的互动式学习编程的网站*
...
> - [**`CodeGym`**](https://codegym.cc/zh/)*一款在线学习Java的教程，边学边玩*
> - [**JavaGuide**](https://javaguide.cn/)*全面Java指南*
> - [**猴子都能懂得Git**](https://backlog.com/git-tutorial/cn/)*一款Git在线查询命令的文档*
> - [**数据结构和算法动态可视化**](https://visualgo.net/zh)*一款免费学习算法的平台*
> - [**Python 在线手册汇总**](https://docs.pythontab.com/)*最全的python学习平台*
> - [**Docker Documentation**](https://docs.docker.com/get-started/)*开源的应用容器引擎 Docker 的官方文档*
> - [**地鼠文档**](http://topgoer.cn)*Go 语言文档大全*
> - [**cppreference**](https://zh.cppreference.com/w/%E9%A6%96%E9%A1%B5)*c++参考手册，非常简洁，及时更新*
...
> - [**华为云沙箱实验室**](https://lab.huaweicloud.com/)*华为操作服务，可通过环境云浏览器进入虚拟操作实验体验*
> - [**阿里知行动手实验室**](https://start.aliyun.com/)*集文档、终端、编辑器三个多为一体，动动鼠标在浏览器中学习最新云开源技术*
> - [**合天网安实验室**](https://www.hetianlab.com/)*免费靶场，和一些网络安全相关的小实验*
> - [**阿里云开发者云实验室体验**](https://developer.aliyun.com/adc/labs/)*利用阿里云免费服务器进行一些小实验，适合新手进行。*
...
> [!TIP]
>
> - 总结自己的一套学习方法至关重要，甚至影响你码农的一生，望大家重视起来
